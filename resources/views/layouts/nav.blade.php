            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="second-top-links">
                        <li class="icon-whatsapp"><a>+1-302-339-3805</a></li>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav main-nav navbar-right">
                    <li class="visible-xs icon-whatsapp" @if( App::getLocale() === 'ar' )style="direction:ltr;"@endif><a href="tel:+1-302-339-3805">+1-302-339-3805</a></li>

                    <li class="{{Request::url() == url('/') ? 'active': ''}} @if( App::getLocale() === 'ar' )pull-right"@endif"><a href="/"><i
                                    class="fa fa-home visible-xs"></i>{{ trans('navs.home') }}</a></li>
                    <li class="{{Request::url() == url('/how-it-works') ? 'active': ''}} @if( App::getLocale() === 'ar' )pull-right"@endif"><a
                                href="{{ url('/how-it-works') }}"><i
                                    class="fa fa-cog visible-xs "></i>{{ trans('navs.how-it-works') }}</a></li>
                    <li class="{{Request::url() == url('/services') ? 'active': ''}} @if( App::getLocale() === 'ar' )pull-right"@endif"><a
                                href="{{ url('/services') }}"><i
                                    class="fa fa-gift visible-xs"></i>{{ trans('navs.services') }}</a></li>
                    <li class="{{request::url() == url('/about') ? 'active': ''}} @if( App::getLocale() === 'ar' )pull-right"@endif"><a href="{{ url('/about') }}"><i
                                    class="fa fa-comments visible-xs"></i>{{ trans('navs.about') }}</a></li>
                    <li class="{{request::url() == url('/faq') ? 'active': ''}} @if( App::getLocale() === 'ar' )pull-right"@endif"><a href="{{ url('/faq') }}"><i
                                    class="fa fa-comments visible-xs"></i>{{ trans('navs.faq') }}</a></li>
                    <li class="{{Request::url() == url('/contact') ? 'active': ''}} @if( App::getLocale() === 'ar' )pull-right"@endif"><a href="{{ url('/contact') }}"><i
                                    class="fa fa-comments visible-xs"></i>{{ trans('navs.contact') }}</a></li>

                    @if ( ! Auth::check())
                        <li class="hidden-xs"><a class="login-button blue-but @if( App::getLocale() === 'ar' )pull-right"@endif" href="#">{{ trans('navs.login') }}</a>
                        </li>
                        <li class="hidden-xs"><a class="orange-but @if( App::getLocale() === 'ar' )pull-right"@endif"
                                                 href="{{ url('/register') }}">{{ trans('navs.new_account') }}</a></li>
                    @else
                        <li class="hidden-xs"><a class="blue-but @if( App::getLocale() === 'ar' )pull-right"@endif"
                    ...
                    <div class="mobile-login">
                            ...
                            <li class="visible-xs">
                                ...
                                <ul>
                                    ...
                                    <li class="form-elements">
                                        <input class="btn orange-but" type="submit" value="{{ trans('navs.login') }}">
                                    </li>
                                    <li class="form-elements">
                                        <a class="btn btn-link forgot-password" href="{{ url('/password/reset') }}">{{ trans('navs.forgot') }}</a>
                                    </li>
                                    {{ Form::close() }}
                        ...
                        @endif
                        <div id="fix-for-navbar-fixed-top-spacing" class="visible-xs" style="height: 120px;">&nbsp;</div>
