...
namespace {
    ...
    class Countries extends \Monarobase\CountryList\CountryListFacade{
        ...
        public static function getDataDir(){
            return \Monarobase\CountryList\CountryList::getDataDir();
        }
         ...
         * @static 
         */
        public static function getOne($countryCode, $locale = 'en', $source = 'cldr'){
            return \Monarobase\CountryList\CountryList::getOne($countryCode, $locale, $source);
        }
         ...
         * @static 
         */
        public static function getList($locale = 'en', $format = 'php', $source = 'cldr'){
            return \Monarobase\CountryList\CountryList::getList($locale, $format, $source);
        }
         ...
         * @static 
         */
        public static function setList($locale, $source, $data){
            return \Monarobase\CountryList\CountryList::setList($locale, $source, $data);
        }
         ...
         * @static 
         */
        public static function has($countryCode, $locale = 'en', $source = 'cldr'){
            return \Monarobase\CountryList\CountryList::has($countryCode, $locale, $source);
        }
